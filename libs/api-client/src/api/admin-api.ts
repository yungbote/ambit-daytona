...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        adminUpdateOrganizationPreviewWarning: async (organizationId: string, organizationPreviewWarning: OrganizationPreviewWarning, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
            assertParamExists('adminUpdateOrganizationPreviewWarning', 'organizationId', organizationId)
            // verify required parameter 'organizationPreviewWarning' is not null or undefined
            assertParamExists('adminUpdateOrganizationPreviewWarning', 'organizationPreviewWarning', organizationPreviewWarning)
            const localVarPath = `/admin/organizations/{organizationId}/preview-warning`
                .replace(`{${"organizationId"}}`, encodeURIComponent(String(organizationId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async adminUpdateOrganizationPreviewWarning(organizationId: string, organizationPreviewWarning: OrganizationPreviewWarning, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminApi.adminUpdateOrganizationPreviewWarning']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        adminUpdateOrganizationPreviewWarning(organizationId: string, organizationPreviewWarning: OrganizationPreviewWarning, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class AdminApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public adminUpdateOrganizationPreviewWarning(organizationId: string, organizationPreviewWarning: OrganizationPreviewWarning, options?: RawAxiosRequestConfig) {
        return AdminApiFp(this.configuration).adminUpdateOrganizationPreviewWarning(organizationId, organizationPreviewWarning, options).then((request) => request(this.axios, this.basePath));
    }
