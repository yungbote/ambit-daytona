...
func (a *ApiServer) Start(ctx context.Context) error {
	...
	a.router.Use(common_errors.NewErrorMiddleware(common.HandlePossibleDockerError, false))
	...
	sandboxController := protected.Group("/sandboxes")
	{
		...
		sandboxController.POST("/:sandboxId/working-copy-captures/sandbox-files", controllers.CaptureSandboxFile)
		sandboxController.POST("/:sandboxId/working-copy-captures/sandbox-files/observe", controllers.ObserveSandboxFile)
		sandboxController.POST("/:sandboxId/working-copy-captures/sandbox-files/read", controllers.ReadSandboxFile)
		sandboxController.POST("/:sandboxId/working-copy-captures/sandbox-files/delete", controllers.DeleteSandboxFile)
