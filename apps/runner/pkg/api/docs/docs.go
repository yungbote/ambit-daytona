...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sandboxes/{sandboxId}/generation/observe": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "ObserveSandboxGeneration",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact source, owner and fence",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/generationstop.GenerationObservationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/generationstop.GenerationObservation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/secrets": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update sandbox secrets",
                        "name": "sandbox",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/UpdateSandboxSecretsDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Sandbox secrets updated",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/sandboxes/{sandboxId}/stop-generation-once": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "StopSandboxGenerationOnce",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact idempotent stopped-generation request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/generationstop.StopRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/generationstop.Receipt"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/stop-generation-once/observe": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "ObserveSandboxGenerationStop",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact stopped-generation request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/generationstop.Observation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Exact capture binding",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureBinding"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureReceipt"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/capabilities": {
            "post": {
                ...
                "operationId": "WorkingCopyCaptureCapabilities",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureCapabilitiesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/delete": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "DeleteWorkingCopyCapture",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact capture identity",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureIdentity"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureDeleteReceipt"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/exists": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "WorkingCopyCaptureExists",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureExistsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/observe": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "ObserveWorkingCopyCapture",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureObservation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/read": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "operationId": "ReadWorkingCopyCapture",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact capture identity and read bounds",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureReadRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.CaptureReadResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/stopped-directory-roster": {
            "post": {
                ...
                "operationId": "StoppedWorkingCopyDirectoryRoster",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sandbox ID",
                    ...
                    {
                        "description": "Exact anchor, directory selector, and bounds",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.StoppedDirectoryRosterRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sandboxes/{sandboxId}/working-copy-captures/stopped-working-tree-inventories/read-range": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "Exact inventory and byte range",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/workingcopy.WorkingTreeInventoryRangeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workingcopy.WorkingTreeInventoryRange"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "generationstop.ExpectedGeneration": {
            "type": "object",
            "required": [
                "containerCreatedAt",
                "containerId",
        ...
        "generationstop.GenerationObservation": {
            "type": "object",
            "required": [
                "fence",
                "generation",
        ...
        "generationstop.GenerationObservationRequest": {
            "type": "object",
            "required": [
                "fence",
                "owner",
        ...
        "generationstop.Purpose": {
            ...
            "properties": {
                ...
                "rendererProcessIdentity": {
                    "$ref": "#/definitions/generationstop.RendererProcessIdentity"
                },
                "sessionId": {
                    "type": "string"
                }
        ...
        "generationstop.RendererProcessIdentity": {
            "type": "object",
            "required": [
                "pid",
                "startTicks"
        ...
        "generationstop.StopRequest": {
            ...
            "properties": {
                ...
                "purpose": {
                    "$ref": "#/definitions/generationstop.Purpose"
                },
                "requestFingerprint": {
                    "type": "string"
                },
        ...
        "generationstop.TerminalGeneration": {
            "type": "object",
            "required": [
                "containerCreatedAt",
                "containerId",
        ...
        "workingcopy.CaptureAuthorityArtifact": {
            "type": "object",
            "required": [
                "digest",
                "ref"
        ...
        "workingcopy.CaptureDeleteReceipt": {
            "type": "object",
            "required": [
                "authority",
                "outcome",
        ...
        "workingcopy.CaptureExistsResponse": {
            "type": "object",
            "required": [
                "authority",
                "owner",
        ...
        "workingcopy.CaptureObservation": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "workingcopy.CaptureReadRequest": {
            "type": "object",
            "required": [
                "authority",
        ...
        "workingcopy.CaptureReadResponse": {
            "type": "object",
            "required": [
                "authority",
                "offset",
        ...
        "workingcopy.StoppedDirectoryRosterEntry": {
            "type": "object",
            "required": [
                "kind",
                "mode",
        ...
        "workingcopy.StoppedDirectoryRosterReceipt": {
            "type": "object",
            "required": [
                "entries",
                "observedAt",
        ...
        "workingcopy.StoppedDirectoryRosterRequest": {
            "type": "object",
            "required": [
                "anchor",
        ...
        "workingcopy.WorkingTreeInventoryBytePack": {
            "type": "object",
            "required": [
                "byteLength",
                "parts",
            ...
            "properties": {
                ...
                "parts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/workingcopy.WorkingTreeInventoryBytePart"
                    }
                },
                "sha256": {
                    "type": "string"
        ...
        "workingcopy.WorkingTreeInventoryBytePart": {
            "type": "object",
            "required": [
                "byteLength",
                "byteOffset",
        ...
        "workingcopy.WorkingTreeInventoryRange": {
            "type": "object",
            "required": [
                "byteLength",
                "bytesBase64",
        ...
        "workingcopy.WorkingTreeInventoryRangeRequest": {
            "type": "object",
            "required": [
                "inventoryDigest",
                "maximumBytes",
        ...
        "workingcopy.WorkingTreeInventoryReceipt": {
            ...
            "properties": {
                ...
                "bytePack": {
                    "$ref": "#/definitions/workingcopy.WorkingTreeInventoryBytePack"
                },
                "entryCount": {
                    "type": "integer"
                },
